...
export const ProjectsApiFetchParamCreator = function(
  ...
  return {
    ...
    clouderrorreportingProjectsDeleteEvents(
      ...
      if (projectName === null || projectName === undefined) {
        throw new RequiredError(
          'projectName',
          'Required parameter projectName was null or undefined when calling clouderrorreportingProjectsDeleteEvents.'
        )
      }
      const localVarPath = `/v1beta1/{projectName}/events`.replace(
        `{${'projectName'}}`,
    ...
    clouderrorreportingProjectsEventsList(
      ...
      pageSize?: number,
      pageToken?: string,
      serviceFilter_resourceType?: string,
      serviceFilter_service?: string,
      ...
      if (projectName === null || projectName === undefined) {
        throw new RequiredError(
          'projectName',
          'Required parameter projectName was null or undefined when calling clouderrorreportingProjectsEventsList.'
        )
      }
      const localVarPath = `/v1beta1/{projectName}/events`.replace(
        `{${'projectName'}}`,
    ...
    clouderrorreportingProjectsEventsReport(
      ...
      if (projectName === null || projectName === undefined) {
        throw new RequiredError(
          'projectName',
          'Required parameter projectName was null or undefined when calling clouderrorreportingProjectsEventsReport.'
        )
      }
      const localVarPath = `/v1beta1/{projectName}/events:report`.replace(
        `{${'projectName'}}`,
        encodeURIComponent(String(projectName))
      )
      const localVarUrlObj = url.parse(localVarPath, true)
    ...
    clouderrorreportingProjectsGroupStatsList(
      ...
      if (projectName === null || projectName === undefined) {
        throw new RequiredError(
          'projectName',
          'Required parameter projectName was null or undefined when calling clouderrorreportingProjectsGroupStatsList.'
        )
      }
      const localVarPath = `/v1beta1/{projectName}/groupStats`.replace(
        `{${'projectName'}}`,
        encodeURIComponent(String(projectName))
      )
      const localVarUrlObj = url.parse(localVarPath, true)
    ...
    clouderrorreportingProjectsGroupsGet(
      ...
      if (groupName === null || groupName === undefined) {
        throw new RequiredError(
          'groupName',
          'Required parameter groupName was null or undefined when calling clouderrorreportingProjectsGroupsGet.'
        )
      }
      const localVarPath = `/v1beta1/{groupName}`.replace(
        `{${'groupName'}}`,
    ...
    clouderrorreportingProjectsGroupsUpdate(
      ...
      if (name === null || name === undefined) {
        throw new RequiredError(
          'name',
          'Required parameter name was null or undefined when calling clouderrorreportingProjectsGroupsUpdate.'
        )
      }
      const localVarPath = `/v1beta1/{name}`.replace(
        `{${'name'}}`,
...
export const ProjectsApiFp = function(configuration?: Configuration) {
  return {
    ...
    clouderrorreportingProjectsDeleteEvents(
      ...
      upload_protocol?: string,
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<DeleteEventsResponse> {
    ...
    clouderrorreportingProjectsEventsList(
      ...
      timeRange_period?:
        ...
        | 'PERIOD_30_DAYS',
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<ListEventsResponse> {
      const localVarFetchArgs = ProjectsApiFetchParamCreator(
        configuration
      ).clouderrorreportingProjectsEventsList(
        projectName,
    ...
    clouderrorreportingProjectsGroupsGet(
      ...
      upload_protocol?: string,
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<ErrorGroup> {
      const localVarFetchArgs = ProjectsApiFetchParamCreator(
        configuration
      ).clouderrorreportingProjectsGroupsGet(
        groupName,
...
export const ProjectsApiFactory = function(
  ...
  return {
    ...
    clouderrorreportingProjectsEventsList(
      ...
      return ProjectsApiFp(configuration).clouderrorreportingProjectsEventsList(
        projectName,
        _xgafv,
        access_token,
        alt,
    ...
    clouderrorreportingProjectsGroupsGet(
      ...
      return ProjectsApiFp(configuration).clouderrorreportingProjectsGroupsGet(
        groupName,
        _xgafv,
        access_token,
        alt,
...
export class ProjectsApi extends BaseAPI implements ProjectsApiInterface {
   ...
   */
  public clouderrorreportingProjectsDeleteEvents(
    projectName: string,
    _xgafv?: '1' | '2',
    access_token?: string,
    alt?: 'json' | 'media' | 'proto',
   ...
   * @memberof ProjectsApi
   */
  public clouderrorreportingProjectsEventsList(
    projectName: string,
    _xgafv?: '1' | '2',
    access_token?: string,
    alt?: 'json' | 'media' | 'proto',
   ...
   * @memberof ProjectsApi
   */
  public clouderrorreportingProjectsEventsReport(
    projectName: string,
    _xgafv?: '1' | '2',
    access_token?: string,
    alt?: 'json' | 'media' | 'proto',
   ...
   * @memberof ProjectsApi
   */
  public clouderrorreportingProjectsGroupsGet(
    groupName: string,
    _xgafv?: '1' | '2',
    access_token?: string,
    alt?: 'json' | 'media' | 'proto',
   ...
   * @memberof ProjectsApi
   */
  public clouderrorreportingProjectsGroupsUpdate(
    name: string,
    _xgafv?: '1' | '2',
    access_token?: string,
    alt?: 'json' | 'media' | 'proto',
